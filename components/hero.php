...
<section id="hero" aria-label="Johnny Davis Ministries Hero">
  ...
  <div class="slider-track" id="sliderTrack">
    ...
    <div class="slide active" id="slide-0">
      <div class="slide-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/hero-image1.webp')"></div>
      <div class="slide-overlay"></div>
    </div>

    <div class="slide" id="slide-1">
      <div class="slide-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/hero-image2.webp')"></div>
      <div class="slide-overlay"></div>
    </div>

    <div class="slide" id="slide-2">
      <div class="slide-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/hero-image3.webp')"></div>
      <div class="slide-overlay"></div>
    </div>

    <div class="slide" id="slide-3">
      <div class="slide-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/hero-image4.webp')"></div>
      <div class="slide-overlay"></div>
    </div>
  ...
  <div class="container" style="height:100%; position:relative; z-index:3;">
    <div class="hero-content">
      ...
      <div class="hero-ctas">
        ...
        <a href="<?= $base ?>donationpage.php" class="btn btn-outline btn-lg">
          &#9829; Support the Mission
        </a>
      </div>
    </div>
