  ...
  <div class="container">
    ...
    <div class="events-grid">
      ...
      <article class="event-card reveal" style="transition-delay:.05s" aria-label="Elevation Prayer — Virtual Prayer Gathering">
        <div class="event-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/elevation-prayer.webp')"></div>
      ...
      <article class="event-card reveal" style="transition-delay:.15s" aria-label="Wake Up To Prayer — Live on TikTok">
        <div class="event-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/wake-up-to-prayer.webp')"></div>
        <div class="event-overlay"></div>
        <div class="event-body">
      ...
      <article class="event-card reveal" style="transition-delay:.25s" aria-label="Elevation Prayer Breakfast">
        <div class="event-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/elevation-prayer-breakfast.webp')"></div>
        <div class="event-overlay"></div>
        <div class="event-body">
      ...
      <article class="event-card reveal" style="transition-delay:.35s" aria-label="12 Keys to Expanding Your Vision and Mission">
        <div class="event-bg" style="background-image:url('<?= $base ?>images/johnny-davis-ministry/vision-and-mision.webp')"></div>
        <div class="event-overlay"></div>
        <div class="event-body">
