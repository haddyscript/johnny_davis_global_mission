  ...
  <div class="container">
    <nav class="nav-inner" aria-label="Main navigation">
      ...
      <ul class="nav-links" role="list">
        ...
        <li><a href="{{ route('home') }}#mission">Mission</a></li>
        <li><a href="{{ route('home') }}#help">How You Can Help</a></li>
        <li><a href="{{ route('news') }}">Blog &amp; News</a></li>
        <li><a href="{{ route('who-we-are') }}" class="active">Who We Are</a></li>
...
<section id="team" aria-labelledby="team-title">
  <div class="container">
    ...
    <div class="team-founder-wrap reveal">
      <div class="team-founder-card" aria-label="Johnny Davis — Founder and President">
        <div class="founder-photo-wrap">
          <img
            class="founder-photo"
            src="{{ asset('images/who-we-are/Johnny-Davis.webp') }}"
    ...
    <div class="team-grid" role="list" aria-label="Our team members">
      ...
      <article class="team-card reveal" style="transition-delay:{{ $member['delay'] }}" role="listitem">
        <div class="team-photo-wrap">
          <img
            class="team-photo"
            src="{{ asset('images/who-we-are/' . $member['photo']) }}"
            alt="{{ $member['name'] }} — {{ $member['role'] }}"
            loading="lazy"
          />
          <div class="team-photo-overlay">
            <span class="team-overlay-role">{{ $member['role'] }}</span>
          </div>
        </div>
        <div class="team-info">
          <h3>{{ $member['name'] }}</h3>
    ...
    <div class="footer-grid">
      ...
      <nav aria-label="Programs navigation">
        ...
        <ul class="footer-links" role="list">
          ...
          <li><a href="{{ route('home') }}#help">Education Support</a></li>
          <li><a href="{{ route('home') }}#help">Clean Water</a></li>
          <li><a href="{{ route('home') }}#help">Community Outreach</a></li>
        </ul>
      </nav>
