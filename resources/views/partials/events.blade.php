  ...
  <div class="container">
    ...
    <div class="events-grid">
      ...
      <article class="event-card reveal" style="transition-delay:.05s" aria-label="Elevation Prayer — Virtual Prayer Gathering"
               data-img="{{ asset('images/johnny-davis-ministry/virtual-prayer-gathering.webp') }}"
               data-title="Elevation Prayer"
               role="button" tabindex="0">
        <div class="event-bg" style="background-image:url('{{ asset('images/johnny-davis-ministry/virtual-prayer-gathering.webp') }}')"></div>
