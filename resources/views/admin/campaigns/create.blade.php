                ...
                <div class="form-section">
                    <div class="form-section-header">
                        ...
                        <div>
                            ...
                            <div class="form-section-sub">Core information shown on the donate page.</div>
                        </div>
                    </div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 80px;gap:16px;">
                        <div class="pf-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input id="title" name="title" type="text" class="pf-input"
                                value="{{ old('title') }}" placeholder="e.g. Feed Filipino Children" required autocomplete="off">
                        ...
                        <div class="pf-group {{ $errors->has('icon') ? 'has-error' : '' }}">
                            ...
                            <input id="icon" name="icon" type="text" class="pf-input"
                                value="{{ old('icon', '🎯') }}" placeholder="🎯" style="text-align:center;font-size:20px;" maxlength="10">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                        <div class="pf-group {{ $errors->has('label') ? 'has-error' : '' }}">
                            ...
                            <input id="label" name="label" type="text" class="pf-input"
                                value="{{ old('label', 'Active Campaign') }}" placeholder="Active Campaign" autocomplete="off">
                        ...
                        <div class="pf-group {{ $errors->has('status_class') ? 'has-error' : '' }}">
                            <label class="pf-label" for="status_class">
                                Status CSS Class
                                <span class="pf-hint">Controls badge colour. e.g. "urgent", "water"</span>
                            </label>
                            <input id="status_class" name="status_class" type="text" class="pf-input"
                                value="{{ old('status_class', 'active-campaign') }}" placeholder="active-campaign" autocomplete="off">
                    ...
                    <div class="pf-group {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                        ...
                        <input id="subtitle" name="subtitle" type="text" class="pf-input"
                            value="{{ old('subtitle') }}" placeholder="e.g. $7.99/month feeds one child" autocomplete="off">
                    ...
                    <div class="pf-group {{ $errors->has('snippet') ? 'has-error' : '' }}">
                        ...
                        <textarea id="snippet" name="snippet" class="pf-input pf-textarea" rows="3"
                            placeholder="Brief description of what this campaign achieves…" maxlength="500">{{ old('snippet') }}</textarea>
                    ...
                    <div class="pf-group {{ $errors->has('story') ? 'has-error' : '' }}">
                        <label class="pf-label" for="story">
                            Pull Quote / Story
                            <span class="pf-hint">Short quote shown on the card, e.g. "Juan's first full meal in weeks."</span>
                        </label>
                        <input id="story" name="story" type="text" class="pf-input"
                            value="{{ old('story') }}" placeholder='"A story from the field."' autocomplete="off">
                ...
                <div class="form-section" style="margin-top:20px;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;">
                        <div class="pf-group {{ $errors->has('goal_amount') ? 'has-error' : '' }}">
                            ...
                            <input id="goal_amount" name="goal_amount" type="text" class="pf-input"
                                value="{{ old('goal_amount') }}" placeholder="$45,000" autocomplete="off">
                        ...
                        <div class="pf-group {{ $errors->has('raised_amount') ? 'has-error' : '' }}">
                            ...
                            <input id="raised_amount" name="raised_amount" type="text" class="pf-input"
                                value="{{ old('raised_amount') }}" placeholder="$32,480" autocomplete="off">
                        ...
                        <div class="pf-group {{ $errors->has('goal_pct') ? 'has-error' : '' }}">
                            ...
                            <input id="goal_pct" name="goal_pct" type="number" class="pf-input"
                                value="{{ old('goal_pct', 0) }}" min="0" max="100" placeholder="72">
                    ...
                    <div class="pf-group {{ $errors->has('meta') ? 'has-error' : '' }}">
                        <label class="pf-label" for="meta">
                            Meta Line
                            <span class="pf-hint">Summary line below the progress bar. e.g. "$32,480 raised of $45,000 goal · 72% funded"</span>
                        </label>
                        <input id="meta" name="meta" type="text" class="pf-input"
                            value="{{ old('meta') }}" placeholder="$32,480 raised of $45,000 goal · 72% funded" autocomplete="off">
                    ...
                    <div class="pf-group {{ $errors->has('bar_style') ? 'has-error' : '' }}">
                        <label class="pf-label" for="bar_style">
                            ...
                            <span class="pf-hint">Optional inline CSS. Leave blank for default teal. e.g. <code>background:linear-gradient(90deg,#c0392b,#e74c3c);</code></span>
                        </label>
                        <input id="bar_style" name="bar_style" type="text" class="pf-input"
                            value="{{ old('bar_style') }}" placeholder="background:linear-gradient(…);" autocomplete="off">
                ...
                <div class="form-section" style="margin-top:20px;">
                    ...
                    <div class="pf-group {{ $errors->has('story_full') ? 'has-error' : '' }}">
                        ...
                        <textarea id="story_full" name="story_full" class="pf-input pf-textarea" rows="4"
                            placeholder="Full story paragraph shown in the donation form…">{{ old('story_full') }}</textarea>
                    ...
                    <div class="pf-group {{ $errors->has('goal_full') ? 'has-error' : '' }}">
                        ...
                        <input id="goal_full" name="goal_full" type="text" class="pf-input"
                            value="{{ old('goal_full') }}" placeholder="Goal: $45,000 to reach 100+ children for full school year" autocomplete="off">
            ...
            <div class="form-sidebar">
                ...
                <div class="form-section">
                    ...
                    <div class="pf-group {{ $errors->has('sort_order') ? 'has-error' : '' }}" style="margin-top:12px;">
                        ...
                        <input id="sort_order" name="sort_order" type="number" class="pf-input"
                            value="{{ old('sort_order', $nextOrder) }}" min="0" placeholder="1">
                ...
                <div class="form-section" style="margin-top:0;">
                    <div class="form-section-header">
                        <span class="form-section-icon">📊</span>
                        <div>
                            <div class="form-section-title">Progress Preview</div>
                        </div>
                    </div>
                    <div style="padding:4px 0;">
                        <div style="display:flex;justify-content:space-between;font-size:12px;margin-bottom:6px;">
                            <span id="prev-raised" style="color:var(--text-muted);">—</span>
                            <span id="prev-pct" style="font-weight:700;color:#0f766e;">0%</span>
                        </div>
                        <div style="height:8px;background:var(--surface-strong);border-radius:99px;overflow:hidden;">
                            <div id="prev-bar" style="height:100%;width:0%;border-radius:99px;background:linear-gradient(90deg,#0f766e,#14b8a6);transition:width .3s;"></div>
                        </div>
                        <div id="prev-goal" style="font-size:11px;color:var(--text-muted);margin-top:4px;">Goal: —</div>
                    </div>
                </div>
...
[pctInput, raisedInput, goalInput].forEach(function (el) {
