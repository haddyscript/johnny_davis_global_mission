  ...
  <div class="container">
    <nav class="nav-inner" aria-label="Main navigation">
      <a href="#hero" class="nav-logo" aria-label="Johnny Davis Global Missions Home">
        <img src="<?= $base ?>images/logo.webp" alt="Johnny Davis Global Missions Logo" />
      </a>
  ...
  <div class="container">
    <div class="mission-grid">
      ...
      <div class="mission-image-wrap reveal-left">
        <img src="<?= $base ?>images/landingpage/feedthehungry.webp"
  ...
  <div class="container">
    <div class="disaster-grid">
      ...
      <div class="disaster-image-wrap reveal-left">
        ...
        <img src="<?= $base ?>images/landingpage/pray_for_earthquake_victems.webp"
  ...
  <div class="container">
    ...
    <div class="help-cards">
      ...
      <article class="help-card reveal" style="transition-delay:.1s">
        <img class="help-card-img" src="<?= $base ?>images/landingpage/community_outreach.webp"
      ...
      <article class="help-card reveal" style="transition-delay:.2s">
        <img class="help-card-img" src="<?= $base ?>images/landingpage/education.webp"
      ...
      <article class="help-card reveal" style="transition-delay:.3s">
        <img class="help-card-img" src="<?= $base ?>images/landingpage/medical_care.webp"
